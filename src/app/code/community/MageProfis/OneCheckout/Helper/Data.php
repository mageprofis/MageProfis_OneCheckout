...
extends Mage_Core_Helper_Abstract
{
    ...
    {
        $active = Mage::getStoreConfigFlag('onecheckout/general/active');
    ...
    public function setAddresses()
    {
        if ($this->getCheckout()->getCheckout()->getIsOneStepCheckout())
        {
            ...
            if ($this->getRequest()->isPost()) {
                $event_object = new Varien_Object();
                $event_object->setResult($result);
                Mage::dispatchEvent('onecheckout_setaddress_before', array(
                    'object' => $event_object
                ));
                if($event_object->getResult()) $result = $event_object->getResult();
                ...
                $event_object = new Varien_Object();
                $event_object->setResult($result);
                Mage::dispatchEvent('onecheckout_setaddress_after', array(
                    'object' => $event_object
                ));
                if($event_object->getResult()) $result = $event_object->getResult();
            }
